$base_dir = "c:\Users\admin\Downloads\Secrets-Manager"

$files = @{}

$files["host\Cargo.toml"] = @"
[package]
name = "traces-sm-host"
version = "0.1.0"
edition = "2021"
...
$files["host\src\routes\secrets.rs"] = @"
...
$files["host\src\routes\lifecycle.rs"] = @"
...
$files["host\src\routes\entropy.rs"] = @"
...
$files["host\src\routes\attest.rs"] = @"
use axum::{routing::{get, post}, Router};
pub fn router() -> Router {
    Router::new()
...
$files["host\src\routes\tokens.rs"] = @"
use axum::{routing::{get, post}, Router};
pub fn router() -> Router {
    Router::new()
...
$files["cli\src\commands\secret.rs"] = @"
use clap::Args;
...
$files["cli\src\commands\token.rs"] = @"
use clap::Args;
use crate::client::Client;
#[derive(Args)]
...
$files["cli\src\commands\attest.rs"] = @"
use clap::Args;
use crate::client::Client;
#[derive(Args)]
...
$files["cli\src\commands\lifecycle.rs"] = @"
use clap::Args;
use crate::client::Client;
#[derive(Args)]
...
$files["cli\src\commands\entropy.rs"] = @"
use clap::Args;
use crate::client::Client;
#[derive(Args)]
...
foreach ($file in $files.GetEnumerator()) {
    $fullPath = Join-Path $base_dir $file.Name
